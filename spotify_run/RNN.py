...
if __name__ == "__main__":
    ...
    #Training 1-Layer RNN with 64 hidden-vector dimension.
    model_64 =  RNN(vocab_size, 50, 64)
    train_model(model_64, epochs=30, lr=0.01)
    #Training RNN with 256 hidden-vector dimension.
#     model_256 =  RNN(vocab_size, 50, 256)
#     train_model(model_256, epochs=100, lr=0.01)
